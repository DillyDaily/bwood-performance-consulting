        ...
        <div className="choosePlan">
          ...
          <div className="ServicesContainer">
            ...
            <h2><strong>Personal Training</strong></h2>
              <p>This package is for individuals that are truly commited to change. I require a deep level of commitment from all of my clients to make sure they are fully engaged and commited to changing their lifestyle. It is only here that we will get true lasting results.</p>
              <p>Contact Billy for Pricing</p>
              <Button size="lg" tag={Link} to={`/contact`}>Contact</Button>
             
            </div>
            <div className="OnlineTrain">
              <h2><strong>Online Training</strong></h2>
                <p> A good majority of people have gym "box" memberships, and get no use out of them.  What if you had a cheap way to get a 4-week training program custom to your goals emailed to you every month?  Well now you do!  Let me maximize your results at the gym of your choice, and on your time without the heavy cost of personal training.</p>
                <p>Contact Billy for Pricing</p>
                <Button size="lg" tag={Link} to={`/contact`}>Contact</Button>
            </div>
          </div>
